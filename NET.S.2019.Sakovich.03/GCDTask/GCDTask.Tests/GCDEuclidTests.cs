...
{
    public class GCDEuclidTests
    {
        private static IEnumerable<TestCaseData> SingleArgumentTestData
        {
            get
            {
                for(int i = - 2; i < 3; i++)
        ...
        private static IEnumerable<TestCaseData> TwoArgumentsTestData
        {
            get
            {
        ...
        {
            GCDEuclid GCDEuclid1 = new GCDEuclid();

            return GCDEuclid1.GCD(x);
        }
